...
/* =====================================================
   ADMIN EXPORT / COPY ACCESS
   ONLY USERS WITH ROLE "admin" CAN COPY OR EXPORT
   SELECTED / PLACED STUDENT RECORDS.
===================================================== */
...
const copyForWhatsApp =
    async (
        ...
        if (!isAdmin) {
            setCopyMessage("Only admin can copy selected or placed students.");
            setTimeout(() => setCopyMessage(""), 3000);
            return;
        }

        if (!records.length) {
            setCopyMessage("No records available to copy.");
...
const exportExcel =
    (
        ...
        if (!isAdmin) {
            setCopyMessage("Only admin can export selected or placed students.");
            setTimeout(() => setCopyMessage(""), 3000);
            return;
        }
            ...
            <div className="student-record-header">
                ...
                <div className="record-actions">
                    ...
                    {!adminAccessLoading && !isAdmin ? (
                        <span title="Copy and Excel export are restricted to admin users.">
                            Admin only: copy / Excel export
                        </span>
                    ) : null}
